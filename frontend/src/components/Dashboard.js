...
//         const combinedData = [...articlesWithType, ...postsWithType].sort(
//           (a, b) => new Date(b.dateFetched) - new Date(a.dateFetched)
//         );
...
//         </Grid>
//         {/* Pass combined data to subcomponents */}
//         <Grid item xs={12} md={12}>
//           <HistoryChart data={data} />
//         </Grid>
//         <Grid item xs={12} md={12}>
//           <SourceRatioChart data={data} />
//         </Grid>
//       </Grid>
//     </Container>
//   );
